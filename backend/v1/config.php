...
define('DATABASE_USERNAME', '4c-master-dba');
define('DATABASE_PASSWORD', '@machmendeSEP2021.X');
define('DATABASE_NAME', '4C-IMS-MasterDB');
...
ini_set('display_errors', 'On'); # Set the php config file to display errors
